	...
	private class MAdapter extends MouseAdapter {
		public void mouseClicked(MouseEvent e) {
			...
			if (jumpBounds.contains(new Point(e.getX(), e.getY()))) {
				...
				Sound bounce = new Sound("jump.wav");
				bounce.play();
